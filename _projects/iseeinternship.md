...
thumbnail: 
  - srcs: "/assets/media/iseeinternship/header.jpg"
    adjustments: [0,0]
sections:
  - type: media
    srcs:
      - "/assets/media/iseeinternship/about.jpg"
    tiling: single
  ...
  - type: media
    srcs:
      - "/assets/media/iseeinternship/testbench.jpg"
    tiling: single
  ...
  - type: media
    srcs:
      - "/assets/media/iseeinternship/testbench-cad.png"
    tiling: single
  ...
  - type: media
    srcs:
      - "/assets/media/iseeinternship/testbench-graph.jpg"
      - "/assets/media/iseeinternship/testbench-simulink.jpg"
    tiling: vertical
  ...
  - type: media
    srcs:
      - "/assets/media/iseeinternship/testbench-caps.jpg"
      - "/assets/media/iseeinternship/testbench-sketch.png"
    tiling: vertical
  ...
  - type: media
    srcs:
      - "/assets/media/iseeinternship/cover1.png"
      - "/assets/media/iseeinternship/cover2.png"
      - "/assets/media/iseeinternship/cover3.png"
      - "/assets/media/iseeinternship/cover4.png"
    tiling: quadrant
  ...
  - type: media
    srcs:
      - "/assets/media/iseeinternship/frontcamera-top.png"
      - "/assets/media/iseeinternship/frontcamera-bottom.png"
      - "/assets/media/iseeinternship/frontcamera-photo.jpg"
    tiling: side
    title: "Camera Mounts"
  ...
  - type: media
    srcs:
      - "/assets/media/iseeinternship/panel-enclosure-cad.png"
      - "/assets/media/iseeinternship/panel-enclosure-crosssection.png"
      - "/assets/media/iseeinternship/panel-enclosure-photo1.jpg"
      - "/assets/media/iseeinternship/panel-enclosure-photo2.jpg"
    tiling: quadrant
